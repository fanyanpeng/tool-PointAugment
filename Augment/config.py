...
# parser.add_argument('--batch_size', type=int, default=24, help='batch size in training')  #原有
...
parser.add_argument('--noise_dim',  default=256, type=int, help='dimension of noise')
