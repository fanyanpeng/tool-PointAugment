...
class Model:
    ...
    def backup(self):
        if not self.opts.restore:
            ...
            # os.system("copy %s/config.py '%s/model_cls.py.backup'" % (source_folder,self.opts.log_dir))
            # os.system("copy %s/model.py '%s/model.py.backup'" % (source_folder,self.opts.log_dir))
            # os.system("copy %s/augmentor.py '%s/augmentor.py.backup'" % (source_folder,self.opts.log_dir))
            # os.system("copy %s/%s.py '%s/%s.py.backup'" % (source_folder,self.opts.model_name, self.opts.log_dir, self.opts.model_name))
            # os.system("copy %s/loss_utils.py '%s/loss_utils.py.backup'" % (common_folder,self.opts.log_dir))
            # os.system("copy %s/ModelNetDataLoader.py '%s/ModelNetDataLoader.py.backup'" % (common_folder,self.opts.log_dir))
